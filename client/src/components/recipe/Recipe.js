...
const Recipe = ({ getRecipe, addLike, addDislike, recipe: { recipe, loading }, match }) => {
    ...
    <div className="single-recipe">
      ...
      <div className="single-recipe-content">
        ...
        <div className="chonk single-recipe-author">
          ...
          <p className="single-recipe-author-text" href="#"> {recipe.name} </p>
        </div>
...
export default connect(mapStateToProps, { getRecipe, addLike, addDislike })(Recipe);